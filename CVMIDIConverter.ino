...
//Dac values 
int noteFrequencies[] = {33, 35, 37, 39, 41, 44, 46, 49, 52, 55, 58, 62, 65, 69, 73, 78, 82, 93, 98, 104, 110, 117, 123, 131, 139, 147, 156, 165, 175, 185, 196, 208, 220, 233, 247, 262};
...
void handleNoteOn(byte channel, byte note, byte velocity){
   fastPWMdac.analogWrite8bit(pwmDacVals[note-37]);
        
  tone(subOscPin,noteFrequencies[note-37]);//turn on note, acts as another oscillator.
